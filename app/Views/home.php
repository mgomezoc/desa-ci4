...
<!-- Mirrored from industrie.rstheme.com/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Feb 2026 15:41:12 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <meta name="template-version" content="1.0.3">
    <title>Industry || HTML Template</title>
...
<body class="rs-smoother-yes">
                    ...
                    <div class="rs-header-left">
                        <div class="rs-header-logo-wrapper">
                            <div class="rs-header-logo">
                                <a href="index.html"><img src="assets/images/logo/logo-orange.png" alt="logo"></a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ul class="mega-menu mega-grid-two">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="red-engineering-one-page.html">Red Engineering</a></li>
                                                <li><a href="blue-construction-one-page.html">Blue Construction</a>
                                                </li>
                                                <li><a href="metallurgy-one-page.html">Metallurgy</a></li>
                                                <li><a href="orange-construction-one-page.html">Construction</a>
                                                </li>
                                                <li><a href="laboratory-one-page.html">Laboratory</a></li>
                                                <li><a href="renewable-energy-one-page.html">Renewable Energy</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#" class="title">Onepage</a>
                                            <ul>
                                                ...
                                                <li><a href="yellow-construction-one-page.html">Yellow Construction</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="mega-menu mega-grid-two">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="metallurgy-one-page.html">Metallurgy</a></li>
                                                <li><a href="orange-construction-one-page.html">Orange Construction</a>
                                                </li>
                                                <li><a href="laboratory-one-page.html">Laboratory</a></li>
                                                <li><a href="renewable-energy-one-page.html">Renewable Energy</a></li>
                                            </ul>
    ...
    <main>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-about-content">
                            <div class="rs-about-description">
                                <p class="descrip-1">Welcome to Industrie, a leading industry innovator with a rich
                                    history of
                                    excellence.</p>
        ...
        <!-- contact area start -->
        <section class="rs-contact-area rs-contact-one section-space black-bg p-relative">
    ...
    <footer class="rs-footer-area rs-footer-one black-bg">
        <div class="rs-footer-bg-thumb" data-background="assets/images/bg/footer-bg-01.png"></div>
        <div class="container">
                    ...
                    <div class="rs-footer-widget footer-1-col-1">
                        ...
                        <div class="rs-footer-widget-content">
                            ...
                            <div class="rs-footer-widget-stroke-text">
                                <h3 class="rs-footer-stroke-text">Since 2007</h3>
                            </div>
                            <div class="rs-footer-copyright underline">
                                <p>© <span id="year"></span> Industrie. Designed by <a
                                        href="https://rstheme.com/">RSTheme</a>
                                </p>
                            </div>
                        </div>
                    </div>
